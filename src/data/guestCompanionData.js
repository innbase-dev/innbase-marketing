...
export const GC_SHOWCASE_IMAGES = [
    { src: "/images/guest-companion-showcase-1.png", alt: "A guest ordering from their phone at a hotel table" },
    { src: "/images/guest-companion-showcase-2.jpg", alt: "A hotel lobby with staff attending to a guest" },
    { src: "/images/guest-companion-showcase-3.png", alt: "A staff member confirming a guest request on a tablet" },
];
