...
const post = {
  ...
  author: "team",
  aiQuestion: "How can we keep requests from WhatsApp, calls and reception in one record, give each request an owner and confirm it is done?",
  cover: {
    src: "/images/blog/guest-requests.webp",
    alt: "A reception bell, desk phone and mobile phone beside two folded towels and a completion check mark.",
    width: 1600,
    height: 1200,
    tone: "sage",
  },
