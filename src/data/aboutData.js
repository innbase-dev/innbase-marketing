...
// ── New for the v2 redesign ──────────────────────────────────────────
// A short, honest rhythm-strip of the phrases that define how we build.
// Deliberately NOT a client-logo wall — we don't have customers to
// showcase yet, and pretending otherwise would break the "honest over
// impressive" line the rest of this page draws. This is our own
// identity, on repeat.
export const IDENTITY_MARQUEE = [
    "Built for reality",
    "Honest by default",
    "One source of truth",
    "Owner-first",
    "Built from Nigeria",
    "Calm on a busy Friday night",
];
