    ...
    <section className="sec" id="roles">
      ...
      <div
        ...
        style={{
          width: 480,
          height: 400,
          background: "radial-gradient(circle,#5b6cf0 0%,transparent 70%)",
          opacity: ".1",
          top: "-80px",
          right: "-120px",
        }}
      ...
      <div className="wrap">
        <Reveal className="sec-head reveal">
          <span className="sec-eyebrow">Whoever&apos;s on shift tonight</span>
          <h2 className="sec-h2">Built for the whole team, not just the owner.</h2>
        </Reveal>
