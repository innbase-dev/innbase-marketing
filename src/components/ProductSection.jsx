...
export default function ProductSection() {
  ...
  const [payLine, setPayLine] = useState({ text: "Needs review · 96%", color: "#fbbf24" });
    ...
    <section className="sec" id="product" style={{ paddingTop: 40 }}>
      ...
      <div className="wrap">
        <Reveal className="sec-head reveal">
          ...
          <h2 className="sec-h2">One dashboard. Every workflow, reconciled automatically.</h2>
          <p className="sec-sub">
            Payments, inventory, shift, and guests all pull from the same numbers — so a naira in
            one workspace is the same naira everywhere else.
          </p>
        </Reveal>
        ...
        >
          <div ref={gridRef} style={{ display: "contents" }}>
            ...
            >
              ...
              <span className="how-chip" style={{ background: "var(--teal-soft)", color: "var(--teal-bright)" }}>
              ...
              <p>
                Bank transfers, POS, and cash counts land in one queue. Innbase proposes the match
                — you just approve it.
              </p>
              <div className="how-mock">
                ...
                <div className="how-mock-body">
                  <div className="how-line">
                    <span>Andrew Nweke · Bank Transfer</span>
                    <span
                  ...
                  <div className="how-line">
                    ...
                    <span className="lv" style={{ color: "#2dd4bf" }}>
                      Completed
                    </span>
                  </div>
                </div>
            ...
            >
              ...
              <span className="how-chip" style={{ background: "var(--amber-soft)", color: "var(--amber-bright)" }}>
                <Icon name="door-open" className="icon" />
              </span>
              <h3>
                Guests <span>— one profile, every stay</span>
              </h3>
              <p>Balance, open tab, and requests in one screen. Reception never checks three systems.</p>
              <div className="gp-card">
                <div className="gp-top">
                  <span className="gp-ava">FA</span>
                  <span className="gp-id">
                    <div className="gp-name">Fola Adeyemi</div>
                    <div className="gp-meta">Checked in Thursday · Deluxe</div>
                  </span>
                ...
                <div className="gp-folio">
                  <div className="gp-line">
                    <span className="d" style={{ background: "#60a5fa" }} />
                    Room charge<span className="gv">₦250,000</span>
                  </div>
                  <div className="gp-line">
                    <span className="d" style={{ background: "#fbbf24" }} />
                    Restaurant &amp; bar tab<span className="gv">₦95,450</span>
                  </div>
                  <div className={`gp-line pay${gpFlash ? " ib-row-flash" : ""}`}>
                    <span className="d" style={{ background: "#2dd4bf" }} />
                    Payment · GT Bank<span className="gv">−₦335,500</span>
                  </div>
                </div>
                ...
                <span className="gp-chip">
                  <Icon name="sparkles" className="icon" style={{ width: 10, height: 10 }} />
            ...
            >
              ...
              <span className="how-chip" style={{ background: "rgba(248,113,113,.1)", color: "#f87171" }}>
                <Icon name="package-search" className="icon" />
              </span>
              <h3>
                Inventory <span>that flags itself</span>
              </h3>
              <p>Every sale deducts stock in real time. Variance comes with a likely cause attached.</p>
              <div className="how-spec">
            ...
            >
              ...
              <span className="how-chip" style={{ background: "rgba(96,165,250,.1)", color: "#60a5fa" }}>
                <Icon name="calendar-clock" className="icon" />
              </span>
              <h3>
                Shift <span>coverage, mapped live</span>
              </h3>
              <p>A live heatmap flags gaps, overtime, and double-bookings before a guest notices.</p>
              <div className="how-spec">
                <span>Coverage</span>
                <b>92%</b>
              </div>
