    ...
    <section className="sec" id="letter">
      <div className="wrap">
        ...
        <Reveal className="letter-card reveal">
          ...
          <p className="letter-salute">To every hotel owner trying to keep it all together,</p>
          <div className="letter-body">
            <p>
              We know the feeling of asking &quot;what happened last night?&quot; and getting
              three different answers from three different people — none of them wrong, exactly,
              just incomplete.
            </p>
            <p>
            ...
            <p>
              That means slower, more careful work than a flashy launch would suggest. We&apos;re
              building this for the long term, one hotel at a time, and we&apos;d rather earn your
              trust than ask for it upfront.
            </p>
          </div>
          <div className="letter-sign">
            <div className="letter-sign-avas">
              <span style={{ background: "var(--brass)" }}>EO</span>
              <span style={{ background: "var(--teal)" }}>CO</span>
            </div>
