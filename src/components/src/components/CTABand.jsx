    ...
    return (
        <section className="cta-band" id="cta">
            ...
            <div className="wrap" style={{ position: "relative", zIndex: 2 }}>
                ...
                >
                    We&apos;re onboarding a small group of Nigerian hotels &amp;
                    bars this quarter. Set up your first workspace in an
                    afternoon — no card, no consultants, no six-week rollout.
                </Reveal>
                <Reveal
