      ...
      <div className="wrap">
        <Reveal className="case-head reveal">
          <div className="sec-head">
            <span className="sec-eyebrow">Pilot properties, real numbers</span>
            <h2 className="sec-h2">Five weeks in, and the ledger finally agrees with itself.</h2>
            <p className="sec-sub">
              Innbase is early — these are the first properties running it end to end, shift
              after shift. Here&apos;s what changed for them.
            </p>
          </div>
              ...
              <article className="case-card" key={c.name}>
                <div className="case-media">
                  ...
                  <div className="case-media-badge">
                    <span className="d" style={{ background: c.badgeDot }} />
                    {c.badge}
                  </div>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={c.img} alt={c.alt} className="case-media-img" loading="lazy" decoding="async" />
                  <div className="case-media-foot">
                    <span className="case-logo">
                      <span className="mk" style={{ background: c.markColor }} />
                      {c.name}
                    </span>
                    <div className="case-logo-sub">{c.sub}</div>
                  </div>
                </div>
            ...
            <article className="case-card case-card--cta">
              <div className="case-media">
                <div className="case-cta-inner">
                  <span className="mk">
                    <Icon name="plus" className="icon" style={{ width: 16, height: 16 }} />
                  </span>
                  <h4>Your property could be next.</h4>
                  <p>We&apos;re onboarding a small group of hotels &amp; bars for the pilot. No card required.</p>
                </div>
              </div>
              <p className="case-caption">
                Set up your first workspace in an afternoon and see your own numbers reconcile
                from day one.
              </p>
              <a href="#cta" className="case-link">
                Book a demo <Icon name="arrow-right" className="icon" />
              </a>
            </article>
          </div>
        </Reveal>
