...
export default function SpotlightMenu({ label, ariaLabel, items, quickLinks, quickLinksLabel = "Explore" }) {
  ...
  return (
    <div className="nav-item" ref={navItemRef} onMouseEnter={openMenu} onMouseLeave={scheduleClose}>
      <button
      ...
      <div className={`mm mm--spot${open ? " open" : ""}`}>
        <div className="mm-spot-inner" role="menu" aria-label={ariaLabel}>
          <div className="mm-modlist">
            ...
            {items.map((item) => (
              <Link
                ...
                role="menuitem"
              >
                <span className="mm-mod-ico" style={{ background: item.iconBg, color: item.iconFg }}>
          ...
          <div className="mm-preview">
            <div className="mm-preview-head">
              ...
              <span className="mm-preview-badge">
                <span className="d" />
                {quickLinksLabel === "Explore" ? "Live preview" : "Preview"}
              </span>
            </div>
            <AnimatePresence mode="popLayout" initial={false}>
              <motion.div
                ...
                <div className="mm-panel">
                  {active.preview.rows.map((row, i) => (
                    <div className="mm-row" key={i}>
                      ...
                      />
                      <span className="mm-row-name">{row.label}</span>
                      <span className="mm-row-chip" style={{ background: row.chipBg, color: row.chipColor }}>
                        {row.chip}
                      </span>
                    </div>
                  ))}
                </div>
                <p className="mm-preview-cap">{active.preview.caption}</p>
              </motion.div>
            </AnimatePresence>
          </div>
        </div>
