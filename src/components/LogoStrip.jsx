export default function LogoStrip() {
  return (
    <section style={{ background: "var(--ink-soft)", padding: "34px 0 30px", borderBottom: "1px solid var(--ink-line)" }}>
      <div className="wrap trust-row" style={{ display: "flex", alignItems: "center", gap: 40, justifyContent: "center" }}>
