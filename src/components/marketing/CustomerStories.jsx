...
const QUOTES = [
  { text: "The stock count finally defends my bartenders instead of accusing them. That changed the whole mood of a Friday night close.", name: "Tunde Bakare", role: "Owner, The Bay Lounge · Lekki Phase 1" },
