        ...
        <section className="sec" id="capacity">
            <div className="wrap">
                <Reveal className="sec-head reveal">
                    ...
                    <h2 className="sec-h2">
                        Your subscription grows with your operation — never a
                        surprise.
                    </h2>
                    <p className="sec-sub">
                        Staff accounts decide your plan. We keep an eye on real
                        usage too, so you stay right-sized as you grow — without
                        ever cutting off a busy shift.
                    </p>
                </Reveal>
