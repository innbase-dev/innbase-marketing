        ...
        <header className="hero">
            ...
            <div className="wrap hero-inner">
                <div className="hero-content">
                    ...
                    >
                        You don&apos;t need to pay for the hotel you hope to
                        become — only the one you&apos;re running today. Three
                        plans, priced only in Naira and sized to your staff,
                        with the exact same platform underneath every tier. Move
                        up only when your team actually grows.
                    </p>
                    <div
