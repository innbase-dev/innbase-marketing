            ...
            <div className="wrap hero-inner">
                <div className="hero-content">
                    <span className="eyebrow reveal in">
                        <span className="dot" />
                        Built for hotels &amp; bars that run on cash, shifts,
                        and trust
                    </span>
                    <h1
                        className="reveal in"
                    ...
                    >
                        Your hotel already generates all the information you
                        need. It&apos;s just scattered across reception, the
                        bar, inventory, payments, and shifts. Innbase connects
                        those pieces into one operational truth, so when
                        something goes wrong, you know exactly what happened.
                    </p>
                    <div
