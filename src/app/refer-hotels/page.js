...
export const metadata = {
  ...
  alternates: {
    canonical: "/refer-hotels",
  },
  ...buildSocialMetadata({ title: TITLE, description: DESCRIPTION, path: "/refer-hotels" }),
};
...
export default function ReferHotelsRoute() {
  return (
    <MarketingShell>
      <ReferralLandingPage />
      <JsonLd data={[faqJsonLd, breadcrumbJsonLd("Refer a hotel", "/refer-hotels")]} />
    </MarketingShell>
  );
}
